...
class WeatherInfoModelsTests: XCTestCase {
    ...
    func testWeatherInfo_HaveDateAndTemperautre() {
        ...
        let sut = WeatherData(dt: 1634011200, temp: Temp(day: 29, min: 27, max: 30), pressure: 134, humidity: 632, weather: [Weather(id: 123, main: "rain", description: "too much rain", icon: "10d")])
